  ...
  return (
    <div className="w-full">
      ...
      {/* Invite Team Member Modal placeholder
          (the source HTML only had the trigger button — no modal markup
          existed for it — wire your actual modal here) */}
      {isInviteModalOpen && (
      ...
      {showSuccessToast && (
        <div className="fixed bottom-6 right-6 left-6 sm:left-auto z-[100] flex items-start gap-4 bg-white p-4 rounded-lg shadow-md border border-neutral-200 sm:max-w-md">
